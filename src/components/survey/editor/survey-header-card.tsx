  ...
  return (
    <div className="survey-card rounded-xl border border-border/30 bg-card p-6 border-t-[3px] shadow-sm" style={{ borderTopColor: accentColor }}>
      <Input
        ...
        className="font-sans border-none !border-0 !ring-0 !shadow-none bg-transparent hover:bg-transparent focus:bg-transparent dark:bg-transparent dark:!bg-transparent text-2xl font-bold p-0 h-auto focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:!border-0 rounded-lg px-3 -mx-3 py-1 transition-colors"
        placeholder="Untitled Survey"
      />
      <Textarea
        value={description}
        onChange={(e) => setDescription(e.target.value)}
        className="font-sans border-none !border-0 !ring-0 !shadow-none bg-transparent hover:bg-transparent focus:bg-transparent dark:bg-transparent dark:!bg-transparent text-muted-foreground p-0 mt-1 resize-none focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:!border-0 min-h-[36px] rounded-lg px-3 -mx-3 py-1 transition-colors"
